...
import { extractSkillsV2, normalizeSkill, computeVelocity } from '../../src/lib/server/analytics/trends_analyzer';

describe('trends analyzer v2', () => {
  it('extracts multi-word phrases and normalizes synonyms', () => {
    const text = 'Experience with Finite Element Analysis (FEA), Solid works, and Machine Learning.';
