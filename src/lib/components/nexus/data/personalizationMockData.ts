import { PersonalizationType, LearningStyle, PersonalityType, AdaptationLevel, ContentDifficulty, UIComplexity } from '../types/personalizationEnums';
  ...
  personalizationRecommendations: [
    {
      ...
      description: "Based on your visual learning preference, we recommend more charts and diagrams" as const,
      confidence: 0.87,
      implemented: true
    },
    {
      ...
      description: "Your investigative personality suggests preference for detailed technical content" as const,
      confidence: 0.92,
      implemented: true
    },
    {
      ...
      description: "High conscientiousness indicates preference for organized, structured interfaces" as const,
      confidence: 0.78,
      implemented: false
    }
  ],
