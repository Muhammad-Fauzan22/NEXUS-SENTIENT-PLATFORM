			...
			<Fade in={isVisible} timeout={1000}>
				<GlassCard>
					<Stack spacing={4} alignItems="center">
						...
						>
							World-Class Intelligence Platform with advanced AI analytics, real-time insights, and
							intelligent automation. Built for the next generation of digital experiences.
						</Typography>
