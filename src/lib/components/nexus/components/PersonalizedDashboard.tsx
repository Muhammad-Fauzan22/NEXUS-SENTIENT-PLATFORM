    ...
    <GlassDashboard elevation={0}>
      ...
      <Box sx={{ mb: 4 }}>
        <Button
          ...
          startIcon={expandedSections.has('recommendations') ? <ExpandLessOutlinedIcon /> : <ExpandMoreOutlinedIcon />}
          sx={{ 
            mb: 2, 
            textTransform: 'none',
            color: theme.palette.text.primary,
      ...
      <Box>
        <Button
          ...
          startIcon={expandedSections.has('analytics') ? <ExpandLessOutlinedIcon /> : <ExpandMoreOutlinedIcon />}
          sx={{ 
            mb: 2, 
            textTransform: 'none',
            color: theme.palette.text.primary,
