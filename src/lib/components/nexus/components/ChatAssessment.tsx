...
const AIMessage = styled(Paper)<{ emotionalState: EmotionalState }>(({ theme, emotionalState }) => {
  const getAnimationSpeed = () => {
    switch (emotionalState) {
      case EmotionalState.STRESSED: return '3s';
      case EmotionalState.ENTHUSIASTIC: return '1s';
      default: return '2s';
    }
  };
  ...
  const getFontWeight = () => {
    switch (emotionalState) {
      case EmotionalState.STRESSED: return 300;
      case EmotionalState.ENTHUSIASTIC: return 500;
      default: return 400;
    }
  };
...
const ThinkingOrb = styled(Box)<{ emotionalState: EmotionalState }>(({ theme, emotionalState }) => {
  const getColor = () => {
    switch (emotionalState) {
      case EmotionalState.STRESSED: return theme.palette.info.main;
      case EmotionalState.ENTHUSIASTIC: return theme.palette.warning.main;
      case EmotionalState.ANXIOUS: return theme.palette.error.main;
      case EmotionalState.CONFIDENT: return theme.palette.success.main;
