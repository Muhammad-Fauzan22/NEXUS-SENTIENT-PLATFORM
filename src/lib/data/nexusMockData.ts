...
export const mockQuery = {
  chatMessages: [
    {
      ...
      content: 'Hello! I\'m NEXUS, your AI development companion. I\'m here to help you discover your potential and create a personalized development plan. Are you ready to begin this journey of self-discovery?',
    ...
    },
    {
      id: 'msg-3',
      sender: MessageSender.AI as const,
      content: 'Wonderful! Let\'s start with understanding your academic background. What is your current field of study?',
  ...
  idpData: {
    id: 'idp-456',
    userId: 'user-123',
    linkedinSummary: 'Aspiring Computer Science graduate with strong analytical skills and passion for AI/ML. Demonstrated leadership in academic projects and community initiatives. Seeking opportunities to apply technical knowledge in innovative software development roles.',
    analysisResults: {
      personalityType: 'INTJ-A',
      strengthsProfile: ['Analytical Thinking', 'Problem Solving', 'Strategic Planning', 'Independent Learning'],
      developmentAreas: ['Public Speaking', 'Team Collaboration', 'Emotional Intelligence', 'Networking']
    },
    roadmap: [
      {
        semester: 1,
        ...
        recommendations: ['Join study groups', 'Attend professor office hours', 'Practice coding daily']
      },
      {
        semester: 2,
        pillar: DevelopmentPillar.PROFESSIONAL as const,
        goals: ['Secure internship application', 'Build portfolio projects'],
        recommendations: ['Update LinkedIn profile', 'Create GitHub portfolio', 'Practice technical interviews']
      },
      {
        semester: 3,
        pillar: DevelopmentPillar.PERSONAL as const,
        goals: ['Improve public speaking', 'Develop leadership skills'],
        recommendations: ['Join Toastmasters', 'Lead a student organization', 'Take communication workshop']
      },
      {
        semester: 4,
        pillar: DevelopmentPillar.SOCIAL as const,
        goals: ['Expand professional network', 'Mentor junior students'],
        recommendations: ['Attend tech meetups', 'Join professional associations', 'Volunteer as tutor']
      }
    ],
    constellationData: [
      {
