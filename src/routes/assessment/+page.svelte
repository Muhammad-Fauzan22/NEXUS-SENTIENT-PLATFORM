...
[{
	"resource": "/c:/Users/fauzan/Documents/Projects/NEXUS-SENTIENT-PLATFORM/src/routes/assessment/+page.svelte",
	"owner": "_generated_diagnostic_collection_name_#8",
	"code": "2307",
	"severity": 8,
	"message": "Cannot find module '$lib/components/assessment/Step2_Riasec.svelte' or its corresponding type declarations.",
	"source": "ts",
	"startLineNumber": 4,
	"startColumn": 27,
	"endLineNumber": 4,
	...
	"code": "2322",
	"severity": 8,
	"message": "Type 'Partial<IStudentProfile>' is not assignable to type 'never'.",
	"source": "ts",
	"startLineNumber": 84,
	"startColumn": 29,
	"endLineNumber": 84,
